 ...
 * @author b1wolt
 */
public class jsonGetHand extends ActionSupport implements LoginRequired
{
    private final List<Card>Hand;
    final static Logger log = Logger.getLogger(jsonGetHand.class);
    public jsonGetHand()
{
    ...
    pokerHands.setPlayer2Hand2(Hand2);
     ...
     try
     {
          File logFile = new File("C:\\Users\\bwoltemate\\cardXML.xml");
